...
def configure_logging(app):
    ...
    """
    # Get log directory and file name from environment variables
    log_dir = os.getenv('LOG_DIR', 'logs')  # Default to 'logs' if not specified
    log_file = os.getenv('LOG_FILE', 'app.log')  # Default to 'app.log' if not specified
